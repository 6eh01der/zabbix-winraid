...
It could be a Zabbix Discovery rule but this script is enough for my purposes) Just checking status of all RAID that exist at the machine and if at least one of them have not `HEALTHY` status trigger will send appropriate notification.
